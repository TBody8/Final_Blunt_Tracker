    ...
    <div className='min-h-screen flex items-center justify-center bg-black text-white p-4 relative overflow-hidden'>
      ...
      >
        <div className="text-center mb-6">
          <h2 className='text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600 blunt-title tracking-wider'>Blunt Tracker</h2>
